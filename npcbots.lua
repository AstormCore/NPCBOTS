...
title:SetText(i18n("NpcBots - NPCBOT Tool"))
...
local adminButton = CreateFrame("Button", "NpcbotsAdminButton", frame, "UIPanelButtonTemplate")
...
local raidButton = CreateFrame("Button", "NpcbotsRaidButton", frame, "UIPanelButtonTemplate")
...
-- Add Revive Button
local reviveButton = CreateFrame("Button", "NpcbotsReviveButton", frame, "UIPanelButtonTemplate")
...
local buttonAdd = CreateFrame("Button", "NpcbotsButtonAdd", adminFrame, "UIPanelButtonTemplate")
...
local buttonRemove = CreateFrame("Button", "NpcbotsButtonRemove", adminFrame, "UIPanelButtonTemplate")
...
local buttonRecall = CreateFrame("Button", "NpcbotsButtonRecall", adminFrame, "UIPanelButtonTemplate")
...
local buttonBotinfo = CreateFrame("Button", "NpcbotsButtonBotInfo", adminFrame, "UIPanelButtonTemplate")
...
local buttonMove = CreateFrame("Button", "NpcbotsButtonMove", adminFrame, "UIPanelButtonTemplate")
...
local buttonDelete = CreateFrame("Button", "NpcbotsButtonDelete", adminFrame, "UIPanelButtonTemplate")
...
local redemptionButton = CreateFrame("Button", "NpcbotsRedemptionButton", adminFrame, "SecureActionButtonTemplate")
...
local botLookupButton = CreateFrame("Button", "NpcbotsBotLookupButton", adminFrame, "UIPanelButtonTemplate")
...
standstillButton:SetScript("OnClick", function()
  ...
  SendChatMessage(".npcbot distance attack 15", "SAY")
  end)

  attackDistanceMediumButton:SetScript("OnClick", function()
  SendChatMessage(".npcbot distance attack 30", "SAY")
  end)

  attackDistanceLongButton:SetScript("OnClick", function()
  SendChatMessage(".npcbot distance attack 50", "SAY")
  end)
...
local lookupFrame = CreateFrame("Frame", "NpcbotsLookupFrame", UIParent)
...
local lookupScrollFrame = CreateFrame("ScrollFrame", "NpcbotsLookupScrollFrame", lookupFrame, "UIPanelScrollFrameTemplate")
...
local lookupList = CreateFrame("Frame", "NpcbotsLookupList", lookupScrollFrame)
...
for key, value in pairs(classTable) do
  local button = CreateFrame("Button", "NpcbotsLookupButton"..value, lookupList, "UIPanelButtonTemplate")
...
local hideLookupButton = CreateFrame("Button", "NpcbotsHideLookupButton", lookupFrame, "UIPanelButtonTemplate")
...
local spawnFrame = CreateFrame("Frame", "NpcbotsSpawnFrame", lookupFrame)
...
local buttonSpawnBot = CreateFrame("Button", "NpcbotsButtonSpawnBot", spawnFrame, "UIPanelButtonTemplate")
...
local classInput = CreateFrame("EditBox", "NpcbotsClassInput", spawnFrame, "InputBoxTemplate")
